...
describe('Contract', () => {
    ...
    it('each employee has 24 yearly vacations by default', () => {
        ...
        let birthDay = new Date(2001, 0, 26)

        const contract = new Contract("Marco Gil", startDate, birthDay)
    ...
    it('special contract overrides yearly vacations', () => {
        ...
        let birthDay = new Date(1999, 6, 12)

        const contract = new SpecialContract("Marco Sanchez", startDate, birthDay, 26)
    ...
    it('double yearly vacations by worked month', () => {
        ...
        let birthDay = new Date(1997, 11, 30)

        const contract = new Contract("Juan Perez", startDate, birthDay)
    ...
    it('add one vacational by year in enterprise', () => {
        ...
        let birthDay = new Date(1989, 5, 9)

        const contract = new Contract("Laura Martinez", startDate, birthDay)
    ...
    it('add one vacational by 5 year in enterprise to employees who are 40 years old or more', () => {
        ...
        let birthDay = new Date(1966, 0, 26)

        const contract = new Contract("Ana Gonzalez", startDate, birthDay)
